...
<p align="center">
  <img src="img/Kindle_img1.jpg" alt="Kindle preview 1" width="32%">
  <img src="img/Kindle_img2.jpg" alt="Kindle preview 2" width="32%">
  <img src="img/Kindle_img3.jpg" alt="Kindle preview 3" width="32%">
</p>
...
工作流文件是 [.github/workflows/daily-gather.yml](.github/workflows/daily-gather.yml)，每天 UTC 00:00 自动运行，也支持手动触发。
...
选择 `Read and write permissions` 并保存。工作流需要写入权限来更新 `data/fetched_urls.txt`，避免每次重复推送同一批文章。
